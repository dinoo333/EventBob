...
import io.eventbob.spring.adapter.HttpEventHandlerAdapter;
 ...
 *
 * <p>This loader creates HTTP adapter instances that wrap remote service calls.
 ...
 * </p>
 *
 * <p>Future extensions could support other transport mechanisms (gRPC, JMS, Kafka, etc.)
