...
/**
 * Dropwizard realization of {@link HealthcheckAcceptanceTest}, run against a real Docker
 * container built from the already-packaged {@code io.eventbob.example.microlith.dw.echo} fat
 * jar.
 */
@Testcontainers
class DropwizardHealthcheckAcceptanceTest extends HealthcheckAcceptanceTest {
