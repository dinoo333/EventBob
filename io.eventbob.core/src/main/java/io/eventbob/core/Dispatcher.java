...
public interface Dispatcher {
   ...
   *
   * <p>This is used for request-response interactions where the sender expects a reply, but
   * wants to
   ...
   * @throws EventHandlingException If an error occurs during event handling or if the timeout is
   *         reached.
   */
