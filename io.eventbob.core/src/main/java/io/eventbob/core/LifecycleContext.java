 ...
 *
 * <p>Provides handler-specific configuration, the dispatcher for sending events,
 * and optional framework-specific context (Spring ApplicationContext, Dropwizard
 * Environment, etc.) when available.
 * </p>
 *
 * <p><b>Framework-Agnostic Design:</b>
 * </p>
 *
 * <p>The core EventBob framework does not depend on any specific framework (Spring,
...
public interface LifecycleContext {
   ...
   *
   * <p>When loading from a JAR, configuration is read from the handler JAR's
   ...
   * </p>
   *
   * <p>Example application.yml (JAR path):
   * </p>
   * <pre>
   * database:
   ...
   *
   * <p>Handlers use the dispatcher to invoke other capabilities during event processing.
   ...
   *
   * <p>This method allows handlers to access framework-specific resources provided by
   ...
   * </p>
   *
   * <p><b>Common framework contexts:</b>
   * </p>
   * <ul>
   ...
   * </ul>
   *
   * <p>Handlers should not assume framework context is available. If the microlith
