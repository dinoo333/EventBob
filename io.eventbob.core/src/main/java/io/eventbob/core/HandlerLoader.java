 ...
 *
 * <p>Implementations can load handlers from:
 * </p>
 * <ul>
 ...
 * </ul>
 *
 * <p>Implementations receive all dependencies via constructor. The parameterless
 ...
 * </p>
 *
 * <p>HandlerLoader extends {@link AutoCloseable} to support resource cleanup. Implementations
...
public interface HandlerLoader extends AutoCloseable {
   ...
   *
   * <p>This factory method returns an implementation that loads handlers
   ...
   * </p>
   *
   * <p><b>Use this for simple handlers with no-arg constructors and no dependencies.</b>
   * </p>
   *
   * <p>For handlers that need initialization (Spring, Dropwizard, databases, etc.),
   ...
   *
   * <p>This factory method returns an implementation that loads handlers using the
   ...
   * </p>
   *
   * <p><b>Use this for handlers that need:</b>
   * </p>
   * <ul>
   ...
   *
   * <p>Similar to {@link #lifecycleLoader(Collection, Dispatcher)} but also provides
   ...
   *
   * <p>Implementations use constructor-injected configuration (JAR paths, remote endpoints,
   ...
   *
   * <p>Implementations should release class loaders, shutdown handler lifecycles,
   * close HTTP clients, and perform any other cleanup necessary. This method
   * is called when EventBob shuts down.
   * </p>
   *
   * <p>Implementations that don't hold resources can provide an empty implementation.
   * </p>
   *
