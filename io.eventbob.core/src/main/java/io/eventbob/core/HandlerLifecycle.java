 ...
 *
 * <p>EventBob is a container for embedded microservices. Like other containers
 * (Servlet, Spring, Dropwizard), it defines a lifecycle contract that handlers
 * must implement to integrate with the container.
 * </p>
 *
 * <p>Handler JARs provide an implementation of this abstract class that knows how
 ...
 * </p>
 * <ol>
 *   <li>{@link #initialize(LifecycleContext)} - Prepare handler with configuration and
 *   dependencies</li>
 ...
 * </pre>
 *
 * <p><b>Why abstract class instead of interface?</b>
 * </p>
 *
 * <p>Abstract class allows evolution without breaking existing implementations. Future
...
public abstract class HandlerLifecycle {
   ...
   *
   * <p>This method is called once after the handler JAR is loaded. Implementations
   ...
   * </p>
   *
   * <p>Implementations may perform expensive operations here (database connections,
   ...
   *
   * <p>Called after {@link #initialize(LifecycleContext)} completes successfully.
   ...
   *
   * <p>Called when EventBob is shutting down. Implementations should close database
   * connections, shutdown thread pools, close Spring contexts, and release any other
   * resources acquired during initialization.
   * </p>
   *
   * <p>This method should be idempotent (safe to call multiple times) and should not
